...
<body>
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-20 left-10 w-72 h-72 bg-blue-600/10 rounded-full blur-3xl"></div>
    ...
    <main class="min-h-screen flex items-center justify-center px-4 py-12 relative z-10">
        <div class="w-full max-w-lg">
            ...
            <div class="flex items-center justify-center gap-4 mb-12">
                ...
                <div>
                    <span class="text-lg md:text-xl lg:text-2xl font-semibold md:font-bold text-white block" >{{ $setting->site_title ?? 'AlgoOne' }}</span>
                    <span class="text-sm text-blue-400/80 font-medium">Professional Trading</span>
                </div>
            </div>

            <!-- Sign Up Card - Split Design -->
            <div class="signup-card rounded-3xl p-10 shadow-2xl">
                <!-- Header Section -->
                <div class="text-center mb-8 pb-8 border-b border-blue-500/20">
                    <div class="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-500/40 rounded-full px-4 py-2 mb-4">
                        ...
                        <span class="text-blue-400 text-sm font-semibold">NEW ACCOUNT</span>
                    </div>
                    <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-3" data-admin="pageTitle">Create Account</h1>
                    <p class="text-blue-300/70 text-lg" data-admin="pageSubtitle">Join thousands of successful traders</p>
                </div>
