            ...
            <div class="login-card rounded-3xl p-10 shadow-2xl">
                ...
                <div class="text-center mb-8 pb-8 border-b border-blue-500/20">
                    <div class="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-500/40 rounded-full px-4 py-2 mb-4">
                        ...
                        <span class="text-blue-400 text-sm font-semibold">ACCESS DASHBOARD</span>
                    </div>
                    <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-3" data-admin="pageTitle">Welcome Back</h1>
                    <p class="text-blue-300/70 text-lg" data-admin="pageSubtitle">Sign in to access your trading dashboard</p>
                </div>
                ...
                <div class="mt-8 text-center pt-8 border-t border-blue-500/20">
                    <p class="text-blue-300/70 text-sm" data-admin="signUpPrompt">
                        Don't have an account?
                        <a href="{{ route('frontend.sign-up') }}" class="text-blue-400 hover:text-blue-300 font-bold transition-colors ml-2" data-admin="signUpLink">
