...
<head>
    ...
    <title data-admin="pageTitle">Forgot Password - {{ $setting->site_title ?? 'AlgoOne' }}</title>
            ...
            <div class="login-card rounded-3xl p-10 shadow-2xl">
                ...
                <div class="text-center mb-8 pb-8 border-b border-blue-500/20">
                    <div class="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-500/40 rounded-full px-4 py-2 mb-4">
                        ...
                        <span class="text-blue-400 text-sm font-semibold">PASSWORD RESET</span>
                    </div>
                    <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-3" data-admin="pageTitle">Forgot Password?</h1>
                    <p class="text-blue-300/70 text-lg" data-admin="pageSubtitle">Enter your email address and we'll send you a link to reset your password</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                    ...
                    <button type="submit"
                        ...
                        data-admin="sendResetLinkButton">
